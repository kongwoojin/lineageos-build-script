...
function pick_patch() {
    ...
    repopick -t Q_asb_2023-07

    repopick -t Q_asb_2023-08

    repopick -t Q_asb_2023-09

    repopick -t Q_asb_2023-10

    repopick -t Q_asb_2023-11

    repopick -t Q_asb_2023-12
    ...
    repopick -t Q_asb_2024-04

    repopick -t Q_asb_2024-05

    repopick -t Q_asb_2024-06

    repopick -t Q_asb_2024-07

    repopick -t Q_asb_2024-08

    repopick -t Q_asb_2024-09

    repopick -t Q_asb_2024-10

    repopick -t Q_asb_2024-11

    repopick -t Q_asb_2024-12

    repopick -t Q_asb_2025-01

    repopick -t Q_asb_2025-02

    repopick -t Q_asb_2025-03
}
